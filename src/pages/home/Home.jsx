...
function Home() {
  ...
  const hashtags = `IstandWithSampa`;
    ...
    <React.Fragment>
      ...
      <div className={styles.home}>
        <section className={styles.infoSection}>
          ...
          <h3>
            Ways you can support the <br /> #IstandWithSampa movement
          </h3>
          ...
          <div className={styles.boxesContainer}>
            ...
            >
              ...
              <h4>Sign the Petition to bring Change </h4>
            </a>
        ...
        <footer className={styles.footer}>
          <section>
            ...
            <ul>
              <li>
                <a
                  href='https://twitter.com/paasolo1986'
                  target='_blank'
                  rel='noreferrer noopener'
                >
                  @paasolo1986
          ...
          <section>
            ...
            <ul>
              ...
              <li>
                <a
                  href='https://www.linkedin.com/in/solomon-ansu-42976956/'
                  target='_blank'
                  rel='noreferrer noopener'
                >
                  LinkedIN
